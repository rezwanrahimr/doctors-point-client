                    ...
                    <div className='grid grid-cols-1 p-12'>
                        <div className="card card-side bg-base-100 w-auto h-auto shadow-xl">
                            ...
                            <div className="card-body w-96">
                                <small className='font-bold text-amber-600'>June 26, 2020</small>
                                ...
                                <h1 className='text-1xl font-bold'>Read More <span className='text-amber-600'>»</span><i class="fa-solid fa-arrow-right-from-line"></i></h1>
